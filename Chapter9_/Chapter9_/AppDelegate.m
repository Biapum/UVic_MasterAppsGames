...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    MountainViewController *vc = [[MountainViewController alloc] init];
...
{
    [Parse setApplicationId:@"VaNQg0FKXb3xtvhEfDlhbpsE3q4a598myGkbOFQp"
                  clientKey:@"Du1udCK3wIpBPLl2ZDSAXj8femXWhgFDMYUwnpQR"];
